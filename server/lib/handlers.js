...
module.exports.api.getVacationsApi = async (req, res) => {
  const vacations = await db.getVacations({ available: true });
  res.json(vacations);
};

module.exports.api.getVacationBySkuApi = async (req, res) => {
  const vacation = await db.getVacations({ sku: req.params.sku });
  res.json(vacation);
};

module.exports.api.addVacationInSeasonListenerApi = async (req, res) => {
  console.log('IN SEASON API CALLED BODY: ', req.body.email, req.body.sku, 'PARAMS: ', req.params.email, req.params.sku);
  await db.addVacationInSeasonListener(req.body.email, req.params.sku);
  res.json({ message: 'success' });
};

module.exports.api.requestVacationDeleteApi = async (req, res) => {
  res.json({ message: 'success' });
};
